...
export const metadata: Metadata = {
  title: 'Aviso Legal — Facturas',
  description: 'Aviso legal e información del titular de Facturas conforme a la LSSI.',
}
        ...
        <div className="space-y-8 text-text-secondary leading-relaxed text-[15px]">
          ...
          <section>
            ...
            <p>
              ...
              localhost:3000 (en adelante, &quot;el Sitio Web&quot;), así como la
          ...
          <section>
            ...
            <p>
              ...
              y servicios que Facturas ofrece a través de su Sitio Web. Entre
            ...
            <ul className="mt-3 space-y-1.5 list-disc list-inside">
              ...
              <li>
                Provocar daños en los sistemas físicos y lógicos de Facturas,
          ...
          <section>
            ...
            <p>
              Facturas no se hace responsable, en ningún caso, de los daños y
          ...
          <section>
            ...
            <p>
              ...
              sujetas a controles por parte de Facturas. Por lo tanto,
              Facturas no podrá ser considerada responsable de los contenidos
          ...
          <section>
            ...
            <p>
              La relación entre Facturas y el usuario se regirá por la
