...
export const metadata: Metadata = {
  title: 'Términos de Servicio — Facturas',
  description: 'Términos y condiciones de uso del servicio Facturas.',
}
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-text-secondary leading-relaxed text-[15px]">
          <section>
            ...
            <p>
              Facturas es una <strong className="text-text">herramienta de diseño y generación de documentos comerciales</strong> (facturas,
              presupuestos) en formato PDF. El servicio está disponible a través de la web en localhost:3000.
            </p>
            <div className="mt-4 p-4 border border-border rounded-lg bg-surface-tertiary">
              ...
              <p>
                Facturas <strong className="text-text">NO es un software de gestión fiscal, contable ni de facturación electrónica</strong> en
                el sentido del Real Decreto 1007/2023 (VeriFactu) ni de la Ley Crea y Crece. Facturas es una herramienta
              ...
              <p className="mt-2">
                ...
                Facturas no asume ninguna responsabilidad sobre la validez fiscal o legal de los documentos generados.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>Facturas ofrece dos modalidades de uso:</p>
          ...
          <section>
            ...
            <p className="mt-3">
              Facturas se reserva el derecho de suspender o cancelar cuentas
          ...
          <section>
            ...
            <p className="mt-3">
              Facturas es una herramienta de generación de documentos y no
          ...
          <section>
            ...
            <p>
              Facturas se proporciona &quot;tal cual&quot; y &quot;según
            ...
            <ul className="mt-3 space-y-1.5 list-disc list-inside">
              <li>
                Facturas no será responsable de pérdidas indirectas,
                incidentales, especiales o consecuentes.
              </li>
              <li>
                La responsabilidad total de Facturas se limita al importe
                efectivamente pagado por el usuario en los 12 meses anteriores
                al evento que genere la reclamación.
              </li>
              <li>
                Facturas no es responsable de la exactitud, legalidad o
          ...
          <section>
            ...
            <p>
              ...
              Web son propiedad de Facturas y están protegidos por
            ...
            <p className="mt-3">
              ...
              facturas, etc.). Facturas no adquiere ningún derecho de
          ...
          <section>
            ...
            <p>
              Facturas se reserva el derecho de modificar, suspender o
