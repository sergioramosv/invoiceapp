...
export const metadata: Metadata = {
  title: 'Política de Privacidad — InvoiceApp',
  description: 'Política de privacidad y protección de datos de InvoiceApp conforme al RGPD.',
}
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-text-secondary leading-relaxed text-[15px]">
          ...
          <section>
            ...
            <p>
              InvoiceApp utiliza únicamente cookies técnicas necesarias para el
