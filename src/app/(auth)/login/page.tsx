  ...
  return (
    <div className="bg-surface rounded-2xl shadow-sm border border-border p-8 space-y-6">
      <div className="text-center">
        ...
        <p className="text-text-secondary mt-1">Accede a tu cuenta de InvoiceApp</p>
      </div>
      ...
      <p className="text-center text-sm text-text-secondary">
        No tienes cuenta?{' '}
        <Link href="/signup" className="text-text font-medium underline underline-offset-4 hover:text-primary transition-colors">Crear cuenta</Link>
      </p>
    </div>
  )
}
